...
| Voron 2.4   | [Trigger post V2.4](STL/Trigger-Posts/LatchyTriggerPost_Voron2.4.stl)     | The trigger post is screwed to the frame using T-Nuts, print flat and scale in x or y if alternative height is needed. |
| Voron Trident   | TBC     | |
